...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/icons/favicon-32.png?v=37", sizes: "32x32", type: "image/png" },
      { url: "/icons/icon-192.png?v=37", sizes: "192x192", type: "image/png" },
    ],
    apple: [{ url: "/icons/apple-touch-icon.png?v=37", sizes: "180x180" }],
  },
};
