...
const STAR_ARCHETYPE: Record<string, string> = {
  ...
  ado: "belt_power",
  lisa: "kpop_bright_f",
  "hayley williams": "belt_power",
  "florence welch": "belt_power",
  "stevie nicks": "alto_dark",
  "olivia rodrigo": "pop_mezzo",
  "sabrina carpenter": "pop_mezzo",
  "christina aguilera": "belt_power",
  "axl rose": "rock_tenor",
  "chris cornell": "rock_tenor",
  "eddie vedder": "folk_warm",
  "steven tyler": "rock_tenor",
  "robert plant": "rock_tenor",
  "billie joe armstrong": "rock_grit",
  "егор крид": "russian_pop_m",
  "мот": "russian_pop_m",
  хабиб: "russian_pop_m",
  "найк борзов": "indie_breathy",
  "юлия чичерина": "rock_tenor",
  "моя мишель": "breathy_pop_f",
  "лусинэ геворкян": "belt_power",
  louna: "belt_power",
  "люся чеботина": "russian_pop_f",
  iowa: "russian_pop_f",
  алсу: "russian_pop_f",
  "ани лорак": "belt_power",
  hozier: "folk_warm",
