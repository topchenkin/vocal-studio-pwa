/**
 * Reference database of well-known singers for «Вокальный архетип».
 *
 * The UI uses these profiles only as bounded, deterministic examples:
 * exact selected gender + detected Fach + region + genre, with categorical
 * brightness/rasp priority. It does not compute identity or similarity scores.
 *
 * Axes:
