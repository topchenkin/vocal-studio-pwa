...
const plans: Array<{
  ...
  },
  {
    ...
    icon: Crown,
    features: ["Запись студийного трека", "Всё из Premium"],
  },
];
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-5 sm:px-6">
        ...
        <section className="rounded-3xl bg-gradient-to-r from-studio-accent/10 via-studio-card to-blue-500/10 p-8 text-center ring-1 ring-studio-border sm:p-12">
          ...
          <p className="mx-auto mt-3 max-w-xl text-studio-muted">
            Кабинет открывается бесплатно. Преподаватель сам ставит вас в
        ...
        <section id="subscriptions" className="scroll-mt-10 py-16">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-studio-muted">
              Подписка не заменяет уроки и не обязательна. Она открывает чат с
              преподавателем, анализатор нот, упражнения и лабораторию — чтобы
              между занятиями прогресс не замирал. Цены в рублях, без НДС. Сами
              уроки вокала оплачиваются отдельно: сумма видна в кабинете до
              платежа.
            </p>
          </div>
