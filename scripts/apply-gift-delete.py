"""Apply admin gift-certificate delete RPC on the VPS. Requires UVS_SSH_PASS."""
...
SQL = ROOT / "supabase-migrations" / "2026-09-12-admin-delete-gift-certificate.sql"
...
def main() -> None:
    ...
    try:
        ...
        print("gift-delete sql applied", flush=True)
    finally:
        client.close()
