"""Apply student cabinet progress SQL on the VPS. Requires UVS_SSH_PASS."""
...
SQL = ROOT / "supabase-migrations" / "2026-09-07-student-cabinet-progress.sql"
...
def main() -> None:
    ...
    try:
        ...
        print("student-cabinet-progress sql applied", flush=True)
    finally:
        client.close()
