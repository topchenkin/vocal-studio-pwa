"""Apply owner lessons/practice SQL on the VPS. Requires UVS_SSH_PASS."""
...
SQL = ROOT / "supabase-migrations" / "2026-09-11-owner-lessons-practice.sql"
...
def main() -> None:
    ...
    try:
        ...
        print("owner-lessons-practice sql applied", flush=True)
    finally:
        client.close()
