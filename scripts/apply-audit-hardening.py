"""Apply audit-hardening SQL on the VPS. Requires UVS_SSH_PASS."""
...
SQL = ROOT / "supabase-migrations" / "2026-09-05-audit-hardening.sql"
...
def main() -> None:
    ...
    try:
        ...
        print("audit-hardening sql applied", flush=True)
    finally:
        client.close()
