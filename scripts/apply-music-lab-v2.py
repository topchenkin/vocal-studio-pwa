"""Apply music-lab v2 SQL on the VPS. Requires UVS_SSH_PASS."""
...
SQL = ROOT / "supabase-migrations" / "2026-08-26-music-lab-v2.sql"
...
def main() -> None:
    ...
    try:
        ...
        print("music-lab v2 sql applied", flush=True)
    finally:
        client.close()
