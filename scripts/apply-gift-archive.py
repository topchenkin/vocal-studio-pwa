"""Apply admin gift-certificate archive RPC on the VPS. Requires UVS_SSH_PASS."""
...
SQL = ROOT / "supabase-migrations" / "2026-09-12-admin-archive-gift-certificate.sql"
...
def main() -> None:
    ...
    try:
        ...
        print("gift-archive sql applied", flush=True)
    finally:
        client.close()
